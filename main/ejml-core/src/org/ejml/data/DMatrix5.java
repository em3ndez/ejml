...
public class DMatrix5 implements DMatrixFixed {
    ...
    public DMatrix5 setTo( double a1, double a2, double a3, double a4, double a5 ) {
        this.a1 = a1;
        this.a2 = a2;
        this.a3 = a3;
        this.a4 = a4;
    ...
    public DMatrix5 setTo( int offset, double[] array ) {
    ...
    public DMatrix5 setTo( DMatrix5 src ) {
        a1 = src.a1;
        a2 = src.a2;
        a3 = src.a3;
        a4 = src.a4;
